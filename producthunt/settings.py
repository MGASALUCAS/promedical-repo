...
SECRET_KEY = 'django-insecure-^nw!2cufxfb#mj7ylf3&^(ot+f8l^^l+*zdsf*r(agk30=tw9^'
...
#         'NAME': 'promedical$mysqldatabase',
#         'USER': 'promedical',
#         'PASSWORD': 'YANGUMWENYEWEmysql',
...
MEDIA_ROOT = os.path.join(BASE_DIR,
                          'media')  # This provide a root directory to where should we save and store our media  files
